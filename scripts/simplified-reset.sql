-- Simplified SQL Script to reset designs and configure consistent storage paths
...
-- Create a function to generate slugified names
...
-- Insert new designs with consistent file paths
DO $$
DECLARE
  design_id uuid;
  user_id uuid;
